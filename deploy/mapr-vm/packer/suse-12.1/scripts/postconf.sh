...
rpm --import http://ftp5.gwdg.de/pub/opensuse/discontinued/distribution/leap/42.1/repo/oss/content.key
zypper addrepo --disable --refresh http://ftp5.gwdg.de/pub/opensuse/discontinued/distribution/leap/42.1/repo/oss/ openSUSE
