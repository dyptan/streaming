...
# Add disabled openSUSE repository to be able to install some extra packages
rpm --import http://ftp5.gwdg.de/pub/opensuse/discontinued/distribution/leap/15.0/repo/oss/gpg-pubkey-3dbdc284-53674dd4.asc
rpm --import http://ftp5.gwdg.de/pub/opensuse/discontinued/distribution/leap/15.0/repo/oss/gpg-pubkey-39db7c82-5847eb1f.asc
rpm --import http://ftp5.gwdg.de/pub/opensuse/discontinued/distribution/leap/15.0/repo/oss/gpg-pubkey-307e3d54-5aaa90a5.asc

zypper addrepo --disable --refresh --priority=50 http://ftp5.gwdg.de/pub/opensuse/discontinued/distribution/leap/15.0/repo/oss/ openSUSE
