...
rpm --import http://ftp5.gwdg.de/pub/opensuse/discontinued/distribution/leap/42.3/repo/oss/content.key
zypper addrepo --disable --refresh --priority=50 http://ftp5.gwdg.de/pub/opensuse/discontinued/distribution/leap/42.3/repo/oss/ openSUSE
